...
class MyProgram : public Fl_Widget {
  int w, h, D;
  public:
    MyProgram (int winx, int winy, int s1, int s2, char *label=0) : Fl_Widget (winx, winy, s1,s2,label) { w = s1; h=s2; }
...
int main(int argc, char *argv[]) {
  int recursionDepth;
    ...
    Fl_Window w(1000,1000,"cs152: sierpinski triangle");
    w.color(56);
    MyProgram p(800,800,800,800);
