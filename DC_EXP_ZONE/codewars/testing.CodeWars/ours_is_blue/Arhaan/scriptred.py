...
#     print(role)
    ...
    if(role == 'S'):
        ...
        if timeframe<190:
                ...
                if timeframe<3:
                        instructions = instructions[timeframe-1]
                elif timeframe<140:
                        if (timeframe-3) % 14<6:
                                instructions = f
                        elif (timeframe-3) % 14==6:
                                instructions = r                                
                        elif (timeframe-3) % 14<13:
                                instructions = b
                        elif (timeframe-3) % 14==13:
                                instructions = l 
...
#     attack possible enemy positions
...
#     more enemy scouts
    if (ActBase.timeframe == 200) and enemy_scout:
            if base.GetElixir() > 500:
                    for i in range(10,14):
                            base.create_robot(f"E{i}")
                            ActBase.last_move[f'E{i}'] = randint(0,4)  
                            ActBase.Emotion[f'E{i}'] = i-10+3
                        #     if base.GetElixir() <= 500:
                        #             break
